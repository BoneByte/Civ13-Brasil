/datum/job
	...
	var/male_tts_voice = "Ricardo"
	var/female_tts_voice = "Camila"
...
/datum/job/civilian/brazilian_portuguese
	default_language = "Português Brasileiro"
	additional_languages = list("Portuguese" = 35, "Spanish" = 10, "English" = 25)
	male_tts_voice = "Ricardo"
	female_tts_voice = "Camila"
...
/datum/job/portuguese
	default_language = "Portuguese"
	additional_languages = list("French" = 25, "Spanish" = 35, "English" = 10)
	male_tts_voice = "Ricardo" // Cristiano
	female_tts_voice = "Camila" //Ines

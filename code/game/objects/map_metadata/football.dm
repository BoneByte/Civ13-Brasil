...
/obj/map_metadata/football_campaign/job_enabled_specialcheck(var/datum/job/J)
	...
	if (istype(J, /datum/job/civilian/football_red_campaign) || istype(J, /datum/job/civilian/football_red_campaign/goalkeeper))
		. = TRUE
	else if (istype(J, /datum/job/civilian/football_blue_campaign) || istype(J, /datum/job/civilian/football_blue_campaign/goalkeeper))
		. = TRUE
	else
		. = FALSE
...
///////////////////////////////////////////////////
/datum/job/civilian/football_red_campaign
	title = "Redmenia United"
	en_meaning = ""
	rank_abbreviation = ""
	spawn_location = "JoinLateCivA"
	min_positions = 10
...
/datum/job/civilian/football_red_campaign/goalkeeper
	title = "Redmenia United Goalkeeper"
	en_meaning = ""
	rank_abbreviation = ""
	spawn_location = "JoinLateCivA"
	min_positions = 1
...
/datum/job/civilian/football_blue_campaign
	title = "Blugoslavia Football Club"
	en_meaning = ""
	rank_abbreviation = ""
	spawn_location = "JoinLateCivB"
	min_positions = 10
...
/datum/job/civilian/football_blue_campaign/goalkeeper
	title = "Blugoslavia Football Club Goalkeeper"
	en_meaning = ""
	rank_abbreviation = ""
	spawn_location = "JoinLateCivB"
	min_positions = 1

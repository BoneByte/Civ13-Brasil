...
/obj/map_metadata/voyage
	...
	var/roundend_msg = "A Partida acabou!"
...
/obj/map_metadata/voyage/proc/gen_ship(sfaction = "random", ssize = 0, slat = 0, slon = 0)
	if (sfaction == "random" || !(sfaction in list("pirates","merchant","spanish","Britanico","undead")))
		sfaction = pick("pirates","merchant","spanish","Britanico","undead")
	if (ssize <= 0 || ssize > 6)

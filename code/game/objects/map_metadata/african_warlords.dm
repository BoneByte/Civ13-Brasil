...
/obj/map_metadata/african_warlords
	...
	respawn_delay = 300
	no_winner ="Nenhuma facção ganhou ainda."
	...
	mission_start_message = "<font size=4>Dois lordes africanos lutando para ver quem humilha o outro. Você precisa tirar da cabeça, os<b>Crânios dos Inimigos</b> e leva-los até o altar do shaman de sua facção. Cada crânio dá 2 pontos para a facção, a facção com <b>30 pontos</b> vence.<br></font>"
	faction1 = INDIANS
	faction2 = CIVILIAN
...
/obj/map_metadata/african_warlords/cross_message(faction)
	return "<font size = 4>Todas as facções podem atravessar a parede invisivel agora!</font>"
...
/obj/map_metadata/african_warlords/update_win_condition()
	if (processes.ticker.playtime_elapsed > 4800)
		...
		if (scores["Yellowagwana"] > scores["Blugisi"])
			message = "A batalha acabou! Os <font color='yellow'><b>Yellowagwana</b></font> Foram vitoriosos contra os <b>Blugisi</b>!"
			world << "<font size = 4><span class = 'notice'>[message]</span></font>"
			win_condition_spam_check = TRUE
			return FALSE
		else if (scores["Blugisi"] > scores["Yellowagwana"])
			message = "A batalha acabou! Os <font color='blue'><b>Blugisi</b></font> Foram vitoriosos contra os <b>Blugisi</b>!"
			world << "<font size = 4><span class = 'notice'>[message]</span></font>"
			win_condition_spam_check = TRUE
			return FALSE
		else
			message = "A batalha ficou em um <b>empasse</b>!"
			world << "<font size = 4><span class = 'notice'>[message]</span></font>"
			win_condition_spam_check = TRUE
			return FALSE
...
/*		switch(head_nationality)
	...
	//			AW.scores["Redkantu"] -= 1
		user << "Você coloca a cabeça no altar."
		if	(prob(20))

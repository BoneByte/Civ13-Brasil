...
/mob/living/simple_animal/hostile/commanded/hear_say(var/message, var/verb = "fala", var/datum/language/language = null, var/alt_name = "", var/italics = FALSE, var/mob/speaker = null, var/sound/speech_sound, var/sound_vol, var/original_message = "")

...
var/list/charge_sounds_us = list(
	'sound/effects/emotes/charge_eng.ogg',)
var/list/charge_sounds_fp = list(
...
var/list/charge_sounds_african = list(
	'sound/effects/emotes/charge_afr1.ogg',
	'sound/effects/emotes/charge_afr2.ogg',
	'sound/effects/emotes/charge_afr3.ogg',
	'sound/effects/emotes/charge_afr4.ogg',
	'sound/effects/emotes/charge_afr5.ogg',
	'sound/effects/emotes/charge_afr6.ogg',
...
var/list/charge_sounds_flamenguista = list(
    'caveirinha_modular/flamengo.ogg',)
var/list/charge_sounds_corinthiano = list(
	'caveirinha_modular/corinthians.ogg',)
...
/proc/get_sfx(soundin)
	if (istext(soundin))
		switch(soundin)
			...
			if ("charge_FLAMENGO")
				soundin = pick(charge_sounds_flamenguista)
			if ("charge_CORINTHIANS")
				soundin = pick(charge_sounds_corinthiano)
			if ("charge_FRENCH")
